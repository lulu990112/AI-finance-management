...
# OpenAI API配置
OPENAI_API_KEY = os.environ.get('OPENAI_API_KEY') or config('OPENAI_API_KEY', default=None)
...
SECRET_KEY = "django-insecure-hk_twhx16w*zdpphnp-fp_f0ny(cbtaecocp80hs#0o5mvf!f7"
...
INSTALLED_APPS = [
    ...
    'django.contrib.sites',      # allauth need
    'rest_framework',
...
AUTHENTICATION_BACKENDS = [
    'django.contrib.auth.backends.ModelBackend',  # 默认用户密码
