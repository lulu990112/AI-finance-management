...
export default function AddGroupTransactionPage() {
  ...
  // 分类选项
  const categories = [
    { value: 'Dining', label: 'Dining', subcategories: ['Breakfast', 'Lunch', 'Dinner', 'Snacks', 'Takeout', 'Others'] },
    { value: 'Transport', label: 'Transport', subcategories: ['Bus', 'Subway', 'Taxi', 'Ride-hailing', 'Gas', 'Parking', 'Others'] },
    { value: 'Shopping', label: 'Shopping', subcategories: ['Clothing', 'Electronics', 'Furniture', 'Cosmetics', 'Others'] },
    { value: 'Entertainment', label: 'Entertainment', subcategories: ['Movies', 'Games', 'Sports', 'Travel', 'Others'] },
    { value: 'Healthcare', label: 'Healthcare', subcategories: ['Medicine', 'Checkup', 'Treatment', 'Others'] },
    { value: 'Education', label: 'Education', subcategories: ['Tuition', 'Books', 'Training', 'Others'] },
    { value: 'Housing', label: 'Housing', subcategories: ['Rent', 'Utilities', 'Property Fee', 'Maintenance', 'Others'] },
    { value: 'Others', label: 'Others', subcategories: ['Others'] }
  ];
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setLoading(true);
    try {
      // Here we need to call the group transaction add API
      // Since there is no direct add group transaction API in the backend, we can achieve it through sharing transactions
      // Or we need to provide a new API interface for the backend
