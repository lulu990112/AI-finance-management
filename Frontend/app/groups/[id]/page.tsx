...
export default function GroupDetailPage() {
  ...
  // When switching to statistics tab, automatically load statistics data
  useEffect(() => {
  ...
  const loadStatistics = async () => {
    ...
    try {
      ...
      if (response && response.success && response.data) {
        ...
        // Handle the case where there is no success field
        setStatistics(response.data);
      } else {
        // Handle the case where the data is directly returned
            ...
            {generating && (
              <span
                style={{
                  ...
                  width: 16,
                  height: 16,
                  border: '2px solid rgba(114,46,209,0.25)',
